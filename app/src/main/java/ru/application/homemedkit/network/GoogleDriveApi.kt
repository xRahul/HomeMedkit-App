...
object GoogleDriveApi {
    ...
    fun isReady(): Boolean = driveService != null
    ...
    suspend fun getFilesMetadata(folderId: String): List<com.google.api.services.drive.model.File>? = withContext(Dispatchers.IO) {
        try {
